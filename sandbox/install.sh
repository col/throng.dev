...
# ─── throng_sandbox bootstrap installer ──────────────────────────────────────────
#
...
#
# Usage:
#   curl -fsSL https://throng.dev/sandbox/install.sh | sudo bash
#   curl -fsSL https://throng.dev/sandbox/install.sh | sudo bash -s -- --version v0.1.0
#   curl -fsSL https://throng.dev/sandbox/install.sh | sudo bash -s -- --uninstall
#
# ─────────────────────────────────────────────────────────────────────────────────

RELEASES_REPO="col/throng.dev"
RELEASE_PREFIX="throng-sandbox-"
...
resolve_latest() {
  ...
  if [[ -z "$tag" ]]; then
    echo -e "\033[0;31m✗\033[0m No throng_sandbox releases found on ${RELEASES_REPO}" >&2
    exit 1
  fi
...
echo -e "\033[0;34m::\033[0m Installing throng_sandbox ${VERSION}"
